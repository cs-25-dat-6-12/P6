import json
from textFiltering import load_data, filter_with_part_scores, filter_with_normalized_scores_revised
...
def create_query_files(query_path, start=10, end=200):
...
if __name__ == "__main__":
    ...
    create_query_files("app/partScores200output.jsonl")